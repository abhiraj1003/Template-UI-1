        ...
        <Offcanvas.Body>
          <Nav className="navbar-nav justify-content-end flex-grow-1 pe-3">
            <div className="dropdown">
              <Nav.Link className="mx-lg-2 dropdown-toggle" href="#" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                Courses
              </Nav.Link>
                ...
                <li>
                  ...
                  <ul className="dropdown-menu dropdown-submenu">
                    <li>
                      ...
                      <ul className="dropdown-menu dropdown-submenu">
                        <li>
                          <a className="dropdown-item" href="#">SAP FICO</a>
                        </li>
                        <li>
                          <a className="dropdown-item" href="#">SAP MM 2</a>
                        </li>
                        <li>
                          <a className="dropdown-item" href="#">SAP SD</a>
                        </li>
                        <li>
                          <a className="dropdown-item" href="#">SAP HR/HCM</a>
                        </li>
                        <li>
                          <a className="dropdown-item" href="#">SAP PP</a>
                        </li>
                        <li>
                          <a className="dropdown-item" href="#">SAP SUCCESSFACTOR</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="dropdown-menu dropdown-submenu">
                        <li>
                          <a className="dropdown-item" href="#">SAP ABAP</a>
                        </li>
                        <li>
                          <a className="dropdown-item" href="#">SAP BASIS</a>
                        </li>
                      </ul>
                    </li> 
                  </ul>
                ...
                <li>
                  ...
                  <ul className="dropdown-menu dropdown-submenu">
                    <li>
                      ...
                      <ul className="dropdown-menu dropdown-submenu">
                        <li>
                            <a className="dropdown-item" href="#">Masters in Data Science </a>
                          </li>
                          <li>
                            <a className="dropdown-item" href="#">Masters in Data Analytics</a>
                          </li>
                          <li>
                            <a className="dropdown-item" href="#">Masters in Business Analytics</a>
                          </li>
                          <li>
                            <a className="dropdown-item" href="#">Chat Gpt and AI</a>
                          </li>
                        </ul>
                    </li>
                    <li>
